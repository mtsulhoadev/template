        ...
        selection.each(function(data) {
            ...
            if (showLabels) {
                ...
                pieLabels.enter().append("g").classed("nv-label",true).each(function(d,i) {
                    ...
                    group.append('text')
                        .style('text-anchor', labelSunbeamLayout ? ((d.startAngle + d.endAngle) / 2 < Math.PI ? 'start' : 'end') : 'middle') //center the text on it's origin or begin/end if ortIndoUinal aligned
                        .style('fill', '#000')
                });
                ...
                pieLabels.select(".nv-label text")
                    .style('text-anchor', function(d,i) {
                        //center the text on it's origin or begin/end if ortIndoUinal aligned
